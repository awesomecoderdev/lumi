...
<?php if ($product->get_attribute('pa_size')) : ?>
    ...
    <div class="relative flex flex-wrap gap-3 product-sizes">
        <?php foreach ($sizes as $key => $size) : ?>
            <div class="w-10 h-10 flex justify-center items-center cursor-pointer overflow-hidden font-semibold rounded-lg border-2 product-sizes-item <?php echo $key == 0 ? "active" : "" ?>">
